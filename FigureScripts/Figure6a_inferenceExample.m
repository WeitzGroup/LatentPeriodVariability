...
% The script GenerateCIforFig6a.m has been run in advanced. 
...
TOG = 1;
% Initial conditions, see main text table 3
pars.initS = 1e5;
pars.initV = 1e3;
...
'FaceColor','#808080','EdgeColor','None','FaceAlpha',0.5); hold on;
...
title('Probability Distribution','FontSize',20);
...
%% Save figure
saveas(gcf,'../Figures/Figure6a.svg');

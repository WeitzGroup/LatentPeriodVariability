...
title('Latent period distribution','FontSize',20);
...
xlabel('Time, hr','FontSize',19);
ylabel('Probability Distribution','FontSize',19);
% Add legend
...
title('One-step growth curve','FontSize',20);
xline(4,'--','Color','#808080','LineWidth',2.5);
ylim([1e2, 5e5]);
...
set(gca,'LineWidth',0.6);
xlabel('Time, hr','FontSize',19);
ylabel('Free virus, PFU/ml','FontSize',19);
